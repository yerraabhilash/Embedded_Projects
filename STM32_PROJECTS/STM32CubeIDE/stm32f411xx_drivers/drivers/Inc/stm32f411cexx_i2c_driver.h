/*
 * stm32f411cexx_i2c_driver.h
 *
 *  Created on: 27-Jan-2026
 *      Author: yerra
 */

#ifndef INC_STM32F411CEXX_I2C_DRIVER_H_
#define INC_STM32F411CEXX_I2C_DRIVER_H_
...
typedef struct
{
	...
	uint32_t        RxSize;    /*To store Repeated start value  */
...
void I2C_SlaveEnDisCallback(I2C_RegDef_t *pI2Cx, uint8_t EnOrDi);//not defined
/*
...
#endif /* INC_STM32F411CEXX_I2C_DRIVER_H_ */
